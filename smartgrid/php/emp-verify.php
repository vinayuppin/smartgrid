<?php
	...
	$sql = "UPDATE emp_details SET verified_flag = 1 WHERE ver_code='$code' and email_id='$email'";
	$res = mysql_query($sql);
	if ($res == 0)
		{
	    ...
	    <div style="padding:2% 5% 5% 5%;">
			...
			<div style="padding: 0% 15%; margin-bottom:30px; margin-top:30px;">
				<div class="alert alert-info">
					<button type="button" class="close" data-dismiss="alert">&times;</button>
					<h4 align="center">Details of Account Authorization will be mailed soon. Keep checking mails for further process and communication.</h4>
				</div>
			</div>
