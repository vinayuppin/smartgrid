<?php
	...
	function sendEmail($vcode, $email, $name, $emp, $pass){
		...
		$body	= "Hello $name,<br/><br/>".
				  "Welcome to Mangalore Electricity Supply Company Limited (MESCOM).Your account in MESCOM has been created. 
				   Please <a href=\"http://$ip_addr/smartgrid/php/admin-verify.php?email=$email&code=$vcode\" target=\"_blank\">CLICK HERE</a> 
